...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// Сохраняем оригинальный вызов существующих профилей конфигурации
	УправлениеДоступомИТ.ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления); 
	
	// ДОБАВЛЯЕМ НАШИ НОВЫЕ ПРОФИЛИ СТРОГО ПО ПРИМЕРУ ИЗ КОММЕНТАРИЯ:
	
	// 1. Профиль: Специалист
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Специалист";
	ОписаниеПрофиля.Идентификатор = "5f268b81-125c-4467-96a8-a6b0cf1b1501";
	ОписаниеПрофиля.Наименование  = "Специалист";
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "7a268b82-225c-4467-96a8-b6b0cf1b1502";
	ОписаниеПрофиля.Наименование  = "Менеджер";
	ОписаниеПрофиля.Роли.Добавить("ВКМ_Менеджер");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	// 3. Профиль: БухгалтерИТФирмы
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "БухгалтерИТФирмы";
	ОписаниеПрофиля.Идентификатор = "9c268b83-325c-4467-96a8-c6b0cf1b1503";
	ОписаниеПрофиля.Наименование  = "БухгалтерИТФирмы";
